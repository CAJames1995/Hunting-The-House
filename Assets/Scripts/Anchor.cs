...
public class Anchor : MonoBehaviour
{
    ...
    ARAnchor CreateAnchor(in ARRaycastHit hit)
    {
        ...
        GameObject anchorGameObject = new GameObject("ARAnchor");
        anchorGameObject.transform.position = hit.pose.position;
        anchorGameObject.transform.rotation = hit.pose.rotation;
